...
module.exports = function upload(req, res) { 
    ...
    form.on('file', function (name, file) {
        ...
        .then((result) => {
            ...
            axios.post(CV_REQUEST, resultUrl, {
                headers: {
        ...
        //     signature: signature,
        // };
        // let filler = fs.createReadStream(file.path);
        // let formData = new FormData();
        // formData.append("file", filler);
        // formData.append("api_key", CLOUD_API_KEY);
        // formData.append("timestamp", timestamp);
        // formData.append("signature", signature);
        // formData.append("upload_preset", "oru5nglz");
        // return axios.post(CLOUD_ENDPOINT, formData)
        // .then((response) => {
        //     console.log('success!');
